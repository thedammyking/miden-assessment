...
export const selectTriggerVariants = cva(
  'flex h-10 w-full items-center justify-between rounded-md border border-neutral-200 bg-white px-3 py-2 text-sm ring-offset-white placeholder:text-neutral-500 focus:outline-none disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1 dark:border-neutral-800 dark:bg-neutral-950  dark:placeholder:text-neutral-400',
  {
    variants: {
      variant: {
        auth: 'border-[#E1EBF5] h-12 rounded text-[#182D41] focus:border-[#182D41] placeholder:text-[#182D41] font-sans font-normal text-sm leading-normal'
      },
      defaultVariants: {
        variant: 'auth'
      }
